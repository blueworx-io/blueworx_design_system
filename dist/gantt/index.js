var BwxGanttBundle = (() => {
  ...
  var F = class {
    ...
    update_bar_position({ x: t = null, width: e = null }) {
      const i = this.$bar;
      if (t) {
        if (!this.task.dependencies.map((a) => this.gantt.get_bar(a).$bar.getX()).reduce((a, o) => a && t >= o, true)) return;
  ...
  (function(window2, document2) {
    "use strict";
    var Bwx = window2.Bwx || {};
    var FrappeGantt = B || window2.Gantt;
    Bwx.Gantt = Bwx.Gantt || {};
    Bwx.Gantt.init = function(selector, tasks, options) {
      var element = typeof selector === "string" ? document2.querySelector(selector) : selector;
