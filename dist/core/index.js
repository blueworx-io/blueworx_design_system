var BwxCoreBundle = (() => {
  ...
  (function(window2, document2) {
    ...
    Bwx.initFlowbite = function() {
      ...
      if (typeof window2.initFlowbite === "function") {
        window2.initFlowbite();
        return true;
      }
      return false;
    };
    ...
    Bwx.Tables.init = function() {
      var tables = document2.querySelectorAll("[data-bwx-table]");
      if (!tables.length) {
        return [];
      }
      if (typeof window2.DataTable !== "function" && !(window2.jQuery && window2.jQuery.fn && window2.jQuery.fn.DataTable)) {
        return [];
      }
      return Array.prototype.map.call(tables, function(table) {
        ...
        if (typeof window2.DataTable === "function") {
          table.bwxDataTable = new window2.DataTable(table);
          return table.bwxDataTable;
        }
        table.bwxDataTable = window2.jQuery(table).DataTable();
        return table.bwxDataTable;
      });
    };
    Bwx.Kanban = Bwx.Kanban || {};
    Bwx.Kanban.init = function() {
      var columns = document2.querySelectorAll("[data-bwx-kanban-col]");
      if (!columns.length || !(window2.jQuery && window2.jQuery.fn && typeof window2.jQuery.fn.sortable === "function")) {
        return [];
      }
      return Array.prototype.map.call(columns, function(column) {
        var $column = window2.jQuery(column);
    ...
    Bwx.Charts.init = function(id, config) {
      var element = typeof id === "string" ? document2.getElementById(id) : id;
      if (!element || typeof window2.Chart !== "function") {
        return null;
      }
      return new window2.Chart(element, config || {});
    };
    Bwx.init = function() {
      Bwx.initFlowbite();
      Bwx.Tables.init();
    ...
    if (document2.readyState === "loading") {
      document2.addEventListener("DOMContentLoaded", Bwx.init);
    } else {
      Bwx.init();
    }
  })(window, document);
